...
DEFAULT_REPO_URL="${MDS_REPO_URL:-git@github.com:AeroHive-community/mavsdk_drone_show.git}"
...
Options:
  ...
  -u, --management-url URL    Specify Netbird Management URL (default: https://nb1.joomtalk.ir)
      --repo-url URL          Specify Git repository URL (default: git@github.com:AeroHive-community/mavsdk_drone_show.git)
